...
turn = 0 #check_win turn (game finished or not)
...
def handle_play(n):
    ...
    button_list [n]["fg"] = "red"
    button_list [n]['disabledforeground'] = "red"
...
bt1=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked1)
bt1.grid(row = 0, column=1)

bt2=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked2)
bt2.grid(row = 0, column=2)

bt3=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked3)
bt3.grid(row = 0, column=3)

bt4=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked4)
bt4.grid(row = 1, column=1)

bt5=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked5)
bt5.grid(row = 1, column=2)

bt6=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked6)
bt6.grid(row = 1, column=3)

bt7=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked7)
bt7.grid(row = 2, column=1)

bt8=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked8)
bt8.grid(row = 2, column=2)

bt9=Button(window, text=" ",bg="grey",fg="black", disabledforeground="black",width = 8, height = 4,font=('Helvetica','20'),command = clicked9)
